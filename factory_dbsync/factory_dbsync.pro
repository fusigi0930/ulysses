...
VERSION = $$GITVER
QMAKE_TARGET_PRODUCT = "ulysses - corridor"
QMAKE_TARGET_DESCRIPTION = "ulysses version factory database sync tool"
QMAKE_TARGET_COPYRIGHT = "Copyright(c) 2016 Embux Inc. All rights reserved"
QMAKE_TARGET_COMPANY = "Embux Inc."

OBJECTS_DIR = $$OUTDIR/factory_dbsync/obj
MOC_DIR = $$OUTDIR/factory_dbsync/obj/moc
DESTDIR = $$OUTDIR/bin
