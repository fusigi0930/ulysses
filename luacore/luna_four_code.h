#ifndef LUNA_FOUR_CODE_H
#define LUNA_FOUR_CODE_H

/**********************************************
 *
 * http://lua-users.org/wiki/LunaFive
 * LunaFive is an enhanced Version of LunaFour.
 * In contrast to LunaFour it works with Lua 5.2 (up to 5.3!).
 * This Library is also faster, when it comes to pushing and
 * creating Objects from both Lua and C++. I also restructured Luna
 * to use less memory since an Objects Methods and Properties are only
 * stored once in a whole State. Furthermore, you can take an objects
 * method an store it in a variable, just like any other function.
